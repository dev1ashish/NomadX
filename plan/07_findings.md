...
> **🔁 Layout update — 2026-05-18.** New entries no longer go here. Each experiment now lives in its own file at [`experiments/YYYY-MM-DD_<slug>.md`](experiments/README.md), with the pre-registration *and* the findings in one place. This file remains the canonical legacy log for entries 2026-05-14 → 2026-05-15; the 2026-05-17 / 2026-05-18 band-chemistry entries below are 3-line stubs pointing at their `experiments/` shards. When adding a new experiment, copy [`experiments/_TEMPLATE.md`](experiments/_TEMPLATE.md) and update [`experiments/README.md`](experiments/README.md) — do **not** append here.
...
> **Migrated to [`experiments/2026-05-17_stage1_stec_triple.md`](experiments/2026-05-17_stage1_stec_triple.md).** Pre-registration + full findings + verdict live there.

**Headline:** Branch (C). Zero of the literature triple (1338/1454/1658) clear the file-level bar; the entire ANOVA top-30 sits in 800–1200 cm⁻¹ LPS region instead.
...
> **Migrated to [`experiments/2026-05-17_stage2_band_features.md`](experiments/2026-05-17_stage2_band_features.md).** Pre-registration + full findings + verdict live there.

**Headline:** `auc_lps_1194` file-level d = +1.03 (STEC > Non-STEC) — cleanest single-band STEC↔Non-STEC discriminator in the project. Stage-gate PASSED.
...
> **Migrated to [`experiments/2026-05-17_stage3_radars_ratios.md`](experiments/2026-05-17_stage3_radars_ratios.md).** Pre-registration + full findings + verdict live there.

**Headline:** Best 1-D STEC↔Non-STEC discriminator at file level is `auc_lps_1194` AUROC = 0.775. Ratios *don't* beat single bands. Literature direction (lipid/protein) partially validated.

---

## 2026-05-17 — Stage 5: engineered-feature classifier — Branch (C) but with two per-strain wins {#2026-05-17--stage5-band-classifier}

> **Migrated to [`experiments/2026-05-17_stage5_band_classifier.md`](experiments/2026-05-17_stage5_band_classifier.md).** Pre-registration + full findings + verdict live there.

**Headline:** Branch (C). LOSO mean 0.312 (below 0.45 floor) — **but Band XGB ties PLS-DA project record on O121H19 LOSO at 0.89** using 13 features instead of 987 raw bins; Protocol A file F1 = 0.870. Stage 6 SKIPPED per stage-gate.
...
> **Migrated to [`experiments/2026-05-18_stage7_mixed_sample.md`](experiments/2026-05-18_stage7_mixed_sample.md).** Pre-registration + full findings + verdict live there.

**Headline:** Branch (B). 2/3 pairs validate briefing 10–20% drop at α=0.7. Classifier has STEC-default class bias under uncertainty. Per-file-mean classification ≠ per-pixel + soft-vote (Stage 5 pipeline must classify per-pixel and aggregate).
