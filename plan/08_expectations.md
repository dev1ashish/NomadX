...
> **🔁 Layout update — 2026-05-18.** Pre-registrations no longer live here. They now sit in the same per-experiment file as the findings, under `## Pre-registration`, at [`experiments/YYYY-MM-DD_<slug>.md`](experiments/README.md). This file remains the canonical legacy pre-reg log for entries 2026-05-14 → 2026-05-15; the 2026-05-17 / 2026-05-18 band-chemistry entries below are 3-line stubs pointing at their `experiments/` shards. When pre-registering a new experiment, copy [`experiments/_TEMPLATE.md`](experiments/_TEMPLATE.md) — do **not** append here.
...
> **Migrated to [`experiments/2026-05-17_stage1_stec_triple.md`](experiments/2026-05-17_stage1_stec_triple.md).** Pre-registration + post-run resolution live there.

**Pre-registered:** plan/14 §6.2 + §6.3. Branch (C) hit — literature triple does not replicate at file level.

---

## 2026-05-17 — Band-chemistry Stage 2: `atlas/band_features.py` module

> **Migrated to [`experiments/2026-05-17_stage2_band_features.md`](experiments/2026-05-17_stage2_band_features.md).** Pre-registration + post-run resolution live there.

**Pre-registered:** plan/14 §5. Stage-gate PASSED — LPS asymmetry E. coli vs Salmonella d = −0.63. `auc_lps_1194` d = +1.03 (headline).

---

## 2026-05-17 — Band-chemistry Stage 3: `notebooks/band_chemistry.ipynb` sections B–E

> **Migrated to [`experiments/2026-05-17_stage3_radars_ratios.md`](experiments/2026-05-17_stage3_radars_ratios.md).** Pre-registration + post-run resolution live there.

**Pre-registered:** plan/14 §6.2–6.5. Ratios falsified as ≥0.80 STEC↔Non-STEC discriminator (best ratio 0.741); single-band `lps_1194` AUROC 0.775 wins. Stage 5 feature set locked.

---

## 2026-05-17 — Band-chemistry Stage 5: engineered-feature classifier

> **Migrated to [`experiments/2026-05-17_stage5_band_classifier.md`](experiments/2026-05-17_stage5_band_classifier.md).** Pre-registration + post-run resolution live there.

**Pre-registered:** plan/14 §6.7 (RQ5). Branch (C) hit — LOSO 0.312 below floor; Protocol A 0.870; O121H19 LOSO 0.89 ties PLS-DA record. Stage 6 SKIPPED per stage-gate.

---

## 2026-05-18 — Band-chemistry Stage 7: mixed-sample degradation simulation

> **Migrated to [`experiments/2026-05-18_stage7_mixed_sample.md`](experiments/2026-05-18_stage7_mixed_sample.md).** Pre-registration + post-run resolution live there.

**Pre-registered:** plan/14 §"Future" (promoted per Stage 5 stage-gate). Branch (B) — 2/3 pairs validate briefing; STEC-prior bias finding; per-file-mean ≠ per-pixel methodology caveat.
